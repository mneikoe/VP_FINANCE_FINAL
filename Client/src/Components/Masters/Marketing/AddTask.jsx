...
const AddTaskMarketing = ({ on, data, onSuccess }) => {
  ...
  const tabItems = [
    { key: "work", label: <span><FileTextOutlined /> Work Description</span> },
              ...
              <Row gutter={[16, 0]}>
                ...
                <Col xs={24} md={12}>
                  <Form.Item
                    ...
                    label="Employee Role"
                    rules={[{ required: true, message: "Required" }]}
                    extra="Marketing tasks can be assigned to single role only"
                  >
                    <Select
                ...
                <Col xs={24} md={12}>
                  <Form.Item
                    ...
                    rules={[{ required: true, message: "Required" }]}
                  >
                    <Input placeholder="Enter marketing task name" size="large" />
                  </Form.Item>
                </Col>
