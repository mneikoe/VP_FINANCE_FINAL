...
const MarketingAssignments = () => {
  ...
  const fetchMarketingTasks = async () => {
    ...
    try {
      ...
      setMarketingTasks(response.data?.tasks || []);
    } catch (error) {
      console.error("Error fetching marketing tasks:", error);
      alert("Failed to fetch marketing tasks: " + error.message);
    } finally {
      setLoading(false);
    }
  };
  ...
  const handleAssignSubmit = async () => {
    ...
    try {
      ...
      if (response.data.success) {
        alert(`✅ Marketing task assigned successfully!`);
        setShowAssignModal(false);
        fetchMarketingTasks(); // Refresh list
      } else {
    ...
    <div className="container-fluid">
      ...
      <div className="d-flex justify-content-between align-items-center mb-3">
        ...
        <div className="d-flex align-items-center">
          ...
          <Button variant="dark" onClick={fetchMarketingTasks}>
          ...
          {filteredTasks.length === 0 ? (
            <div className="text-center py-5">
              ...
              <p className="text-muted">
                Create marketing task templates first to assign them to
                employees.
              </p>
            </div>
          ) : (
      ...
      >
        <Modal.Header className="bg-dark text-white">
          <Modal.Title className="d-flex align-items-center">
            ...
            <div>
              <h5 className="mb-0">Assign Marketing Task</h5>
