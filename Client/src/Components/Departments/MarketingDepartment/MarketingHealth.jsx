...
const KIND_OF_FORM = "health_insurance"; // 🔒 FIXED FOR THIS PAGE
...
const MarketingHealth = () => {
  ...
  return (
    <div className="p-4">
      {/* Header */}
      <div className="navbar flex justify-center mb-6 border-b border-gray-200">
        <button
          className="px-4 py-2 bg-blue-600 text-white rounded"
          onClick={() => setOpen(true)}
        >
          + Add Marketing Health Form
        </button>
      </div>
          ...
          {loading ? (
            ...
            forms.map((f) => (
              <tr key={f._id}>
                ...
                <td className="border px-2 py-1 gap-2 flex justify-center">
                  <button
...
export default MarketingHealth;
