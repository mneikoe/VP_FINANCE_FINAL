...
const CallAfterSomeTimePage = () => {
  ...
  // Filter for "Call After Sometimes" whose latest task is NOT forwarded after
  const data = suspects
    .filter((suspect) => {
      ...
      // Latest task must be "Call After Sometimes"
      if (lastTask.taskStatus !== "Call After Sometimes") return false;
  ...
  return <LeadsTableLayout title="Call After Some Time" data={data} columns={columns} />;
};

export default CallAfterSomeTimePage;
