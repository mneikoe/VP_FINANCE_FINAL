...
const BusyOnAnotherCallPage = () => {
  ...
  // Filter for "Busy on Another Call" leads whose latest task is NOT forwarded after
  const data = suspects
    .filter((suspect) => {
      ...
      // Latest task must be "Busy on Another Call"
      if (lastTask.taskStatus !== "Busy on Another Call") return false;
  ...
  return <LeadsTableLayout title="Busy On Another Call" data={data} columns={columns} />;
};

export default BusyOnAnotherCallPage;
